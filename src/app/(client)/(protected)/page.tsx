    ...
    <>
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-on-background lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight">
              Landing Page for JWT Authentication
            </h1>
            <p className="py-5 text-xl leading-normal text-on-background[.7] lg:text-xl xl:text-2xl">
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <Link
                href={'/login'}
                className="px-8 py-4 text-lg font-medium text-center text-white bg-indigo-600 rounded-md hover:opacity-70 transition-opacity duration-300"
              >
                Get Started
              </Link>
              <a
        ...
        <div className="flex items-center justify-center w-full lg:w-1/2">
          <div className="">
            <Image
              ...
              alt="Nextly Landing Page Template"
              loading="eager"
            />
          </div>
        </div>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-on-background/[.9]">
            Trusted by <span className="text-indigo-500">2000+</span> customers
            worldwide
          </div>

          <div className="flex flex-wrap justify-center gap-5 mt-10 md:justify-around">
            <div className="pt-2 text-on-background/[.6]">
              <AmazonLogo />
            </div>
            <div className="text-on-background/[.6]">
              <VerizonLogo />
            </div>
            <div className="text-on-background/[.6]">
              <MicrosoftLogo />
            </div>
            <div className="pt-1 text-on-background/[.6]">
              <NetflixLogo />
            </div>
            <div className="pt-2 text-on-background/[.6]">
              <SonyLogo />
...
const SectionTitle = (props: Readonly<SectionTitleProps>) => {
  return (
    ...
    >
      {props.preTitle && (
        <div className="text-sm font-bold tracking-wider text-on-background/[.8] uppercase">
          {props.preTitle}
        </div>
      )}

      {props.title && (
        <h2 className="max-w-2xl mt-3 text-3xl font-bold leading-snug tracking-tight text-on-background lg:leading-tight lg:text-4xl">
          {props.title}
        </h2>
      )}

      {props.children && (
        <p className="max-w-2xl py-4 text-lg leading-normal text-on-background/[.7] lg:text-xl xl:text-xl">
          {props.children}
        </p>
      )}
    </Container>
...
function Video({ videoId }: Readonly<VideoProps>) {
    ...
    <Container>
      <div className="grid gap-10 lg:grid-cols-2 xl:grid-cols-3">
        <div className="lg:col-span-2 xl:col-auto">
          <div className="flex flex-col justify-between w-full h-full bg-foreground px-14 rounded-2xl py-14">
...
function Avatar(props: Readonly<AvatarProps>) {
  return (
    <div className="flex items-center mt-8 space-x-3">
      <div className="flex-shrink-0 overflow-hidden rounded-full w-14 h-14 bg-on-foreground/[.3]"></div>
      <div>
...
function Mark(props: { readonly children: React.ReactNode }) {
  return (
    <>
      {' '}
      <mark className="rounded-md text-background bg-on-background/[.9] p-1">
        {props.children}
      </mark>{' '}
    </>
  );
